(function (global, factory) {
  ...
  let pathExists$3 = async (path) => {
    ...
    let [reserves, token0, token1] = await Promise.all([
      web3ClientEvm.request({ blockchain: 'bsc', address: pair, method: 'getReserves', api: basics$3.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'bsc', address: pair, method: 'token0', api: basics$3.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'bsc', address: pair, method: 'token1', api: basics$3.pair.api, cache: 3600000 })
    ]);
  ...
  let pathExists$2 = async (path) => {
    ...
    let [reserves, token0, token1] = await Promise.all([
      web3ClientEvm.request({ blockchain: 'polygon', address: pair, method: 'getReserves', api: basics$2.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'polygon', address: pair, method: 'token0', api: basics$2.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'polygon', address: pair, method: 'token1', api: basics$2.pair.api, cache: 3600000 })
    ]);
  ...
  let pathExists$1 = async (path) => {
    ...
    let [reserves, token0, token1] = await Promise.all([
      web3ClientEvm.request({ blockchain: 'ethereum', address: pair, method: 'getReserves', api: basics$1.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'ethereum', address: pair, method: 'token0', api: basics$1.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'ethereum', address: pair, method: 'token1', api: basics$1.pair.api, cache: 3600000 })
    ]);
  ...
  let pathExists = async (path) => {
    ...
    let [reserves, token0, token1] = await Promise.all([
      web3ClientEvm.request({ blockchain: 'velas', address: pair, method: 'getReserves', api: basics.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'velas', address: pair, method: 'token0', api: basics.pair.api, cache: 3600000 }),
      web3ClientEvm.request({ blockchain: 'velas', address: pair, method: 'token1', api: basics.pair.api, cache: 3600000 })
    ]);
