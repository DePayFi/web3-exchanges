(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@depay/web3-tokens'), require('@depay/web3-constants'), require('ethers'), require('@depay/web3-client'), require('@depay/solana-web3.js')) :
  typeof define === 'function' && define.amd ? define(['exports', '@depay/web3-tokens', '@depay/web3-constants', 'ethers', '@depay/web3-client', '@depay/solana-web3.js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Web3Exchanges = {}, global.Web3Tokens, global.Web3Constants, global.ethers, global.Web3Client, global.SolanaWeb3js));
}(this, (function (exports, web3Tokens, web3Constants, ethers, web3Client, solanaWeb3_js) { 'use strict';
  ...
  let pathExists$3 = async (path) => {
    ...
    let [reserves, token0, token1] = await Promise.all([
      web3Client.request({ blockchain: 'bsc', address: pair, method: 'getReserves', api: basics$3.pair.api, cache: 3600000 }),
      web3Client.request({ blockchain: 'bsc', address: pair, method: 'token0', api: basics$3.pair.api, cache: 3600000 }),
      web3Client.request({ blockchain: 'bsc', address: pair, method: 'token1', api: basics$3.pair.api, cache: 3600000 })
    ]);
  ...
  let route$4 = ({
    ...
    return new Promise(async (resolve)=> {
      let path = await findPath$3({ tokenIn, tokenOut });
  ...
  var pancakeswap = new Exchange(
    Object.assign(basics$3, { route: route$4, getAmountIn: getAmountIn$3 })
  );
  ...
  let pathExists$2 = async (path) => {
    ...
    let [reserves, token0, token1] = await Promise.all([
      web3Client.request({ blockchain: 'polygon', address: pair, method: 'getReserves', api: basics$2.pair.api, cache: 3600000 }),
      web3Client.request({ blockchain: 'polygon', address: pair, method: 'token0', api: basics$2.pair.api, cache: 3600000 }),
      web3Client.request({ blockchain: 'polygon', address: pair, method: 'token1', api: basics$2.pair.api, cache: 3600000 })
    ]);
  ...
  let pathExists = async (path) => {
    ...
    let [reserves, token0, token1] = await Promise.all([
      web3Client.request({ blockchain: 'ethereum', address: pair, method: 'getReserves', api: basics.pair.api, cache: 3600000 }),
      web3Client.request({ blockchain: 'ethereum', address: pair, method: 'token0', api: basics.pair.api, cache: 3600000 }),
      web3Client.request({ blockchain: 'ethereum', address: pair, method: 'token1', api: basics.pair.api, cache: 3600000 })
    ]);
