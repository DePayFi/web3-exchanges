(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@depay/web3-blockchains'), require('@depay/web3-client'), require('ethers'), require('@depay/web3-tokens'), require('@depay/solana-web3.js'), require('decimal.js')) :
  typeof define === 'function' && define.amd ? define(['exports', '@depay/web3-blockchains', '@depay/web3-client', 'ethers', '@depay/web3-tokens', '@depay/solana-web3.js', 'decimal.js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Web3Exchanges = {}, global.Web3Blockchains, global.Web3Client, global.ethers, global.Web3Tokens, global.SolanaWeb3js, global.Decimal));
}(this, (function (exports, Blockchains, web3Client, ethers, Token, solanaWeb3_js, Decimal) { 'use strict';
