...
let pathExists$1 = async (path) => {
  ...
  let [reserves, token0, token1] = await Promise.all([
    request({ blockchain: 'polygon', address: pair, method: 'getReserves', api: basics$2.contracts.pair.api, cache: 3600000 }),
    request({ blockchain: 'polygon', address: pair, method: 'token0', api: basics$2.contracts.pair.api, cache: 3600000 }),
    request({ blockchain: 'polygon', address: pair, method: 'token1', api: basics$2.contracts.pair.api, cache: 3600000 })
  ]);
...
let pathExists = async (path) => {
  ...
  let [reserves, token0, token1] = await Promise.all([
    request({ blockchain: 'ethereum', address: pair, method: 'getReserves', api: basics.contracts.pair.api, cache: 3600000 }),
    request({ blockchain: 'ethereum', address: pair, method: 'token0', api: basics.contracts.pair.api, cache: 3600000 }),
    request({ blockchain: 'ethereum', address: pair, method: 'token1', api: basics.contracts.pair.api, cache: 3600000 })
  ]);
