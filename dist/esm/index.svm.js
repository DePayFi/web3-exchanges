import { Connection, ACCOUNT_LAYOUT, PublicKey, struct, u32, publicKey, u64 as u64$1, u8, bool, rustEnum, str, u16, option, vec, Buffer, BN, TransactionInstruction, SystemProgram, u128, seq, i32, i128, Keypair, blob, bs58 } from '@depay/solana-web3.js';
...
const TWO$1 = new BN(2);
const U64_MAX = TWO$1.pow(new BN(64)).sub(ONE$1);
...
class BitMath {
  ...
  static isOverLimit(n0, limit) {
    const limitBN = TWO$1.pow(new BN(limit)).sub(ONE$1);
