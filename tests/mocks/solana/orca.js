...
async function mockPool({
  ...
  let data = Buffer.alloc(exchange('solana').solana.router.api.span)
  ...
  mock({
    ...
    request: {
      ...
      return: [{ account: { data, executable: false, lamports: 2039280, owner: exchange('solana').solana.router.address, rentEpoch: 327 }, pubkey: pool }]
    }
  })
  ...
  mock({
    ...
    request: {
      ...
      to: pool,
      api: exchange('solana').solana.router.api,
      return: {
...
async function mockPools({
  ...
  let poolTwoData = Buffer.alloc(exchange('solana').solana.router.api.span)
  exchange('solana').solana.router.api.encode({
    anchorDiscriminator: new BN("676526073106765119"),
    whirlpoolsConfig: new PublicKey("2LecshUwdy9xi7meFgHtFJQNSKk4KdTrcpvaB56dP2NQ"),
    whirlpoolBump: [255],
  ...
  mock({
    ...
    request: {
      ...
      return: [{ account: { data: poolTwoData, executable: false, lamports: 2039280, owner: exchange('solana').solana.router.address, rentEpoch: 327 }, pubkey: poolTwo }]
    }
  })
  ...
  let poolOneData = Buffer.alloc(exchange('solana').solana.router.api.span)
  exchange('solana').solana.router.api.encode({
    anchorDiscriminator: new BN("676526073106765119"),
    whirlpoolsConfig: new PublicKey("2LecshUwdy9xi7meFgHtFJQNSKk4KdTrcpvaB56dP2NQ"),
    whirlpoolBump: [255],
  ...
  mock({
    ...
    request: {
      ...
      return: [{ account: { data: poolOneData, executable: false, lamports: 2039280, owner: exchange('solana').solana.router.address, rentEpoch: 327 }, pubkey: poolOne }]
    }
  })
