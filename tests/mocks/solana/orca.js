...
async function mockPool({
  ...
  let data = Buffer.alloc(exchange[blockchain].router.v1.api.span)
  exchange[blockchain].router.v1.api.encode({
  ...
  mock({
    ...
    request: {
      ...
      return: [{ account: { data, executable: false, lamports: 2039280, owner: exchange[blockchain].router.v1.address, rentEpoch: 327 }, pubkey: pool }]
    }
  })
  ...
  mock({
    ...
    request: {
      ...
      to: pool,
      api: exchange[blockchain].router.v1.api,
      return: {
...
async function mockPools({
  ...
  let poolTwoData = Buffer.alloc(exchange[blockchain].router.v1.api.span)
  exchange[blockchain].router.v1.api.encode({
    anchorDiscriminator: new BN("676526073106765119"),
    whirlpoolsConfig: new PublicKey("2LecshUwdy9xi7meFgHtFJQNSKk4KdTrcpvaB56dP2NQ"),
    whirlpoolBump: [255],
  ...
  mock({
    ...
    request: {
      ...
      return: [{ account: { data: poolTwoData, executable: false, lamports: 2039280, owner: exchange[blockchain].router.v1.address, rentEpoch: 327 }, pubkey: poolTwo }]
    }
  })
  ...
  let poolOneData = Buffer.alloc(exchange[blockchain].router.v1.api.span)
  exchange[blockchain].router.v1.api.encode({
    anchorDiscriminator: new BN("676526073106765119"),
    whirlpoolsConfig: new PublicKey("2LecshUwdy9xi7meFgHtFJQNSKk4KdTrcpvaB56dP2NQ"),
    whirlpoolBump: [255],
  ...
  mock({
    ...
    request: {
      ...
      return: [{ account: { data: poolOneData, executable: false, lamports: 2039280, owner: exchange[blockchain].router.v1.address, rentEpoch: 327 }, pubkey: poolOne }]
    }
  })
