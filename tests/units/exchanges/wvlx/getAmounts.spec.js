...
describe('wvlx', () => {
  ...
  describe('getAmounts', ()=>{
    ...
    it('provides the same amounts (amountIn==amountOut) for ETH<>WETH', async ()=> {
      ...
      const path = ['0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', CONSTANTS.velas.WRAPPED]
    ...
    it('provides the same amounts (amountIn==amountOut) for WETH<>ETH', async ()=> {
      ...
      const path = [CONSTANTS.velas.WRAPPED, '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE']
      const amountOut = '100000000000'
