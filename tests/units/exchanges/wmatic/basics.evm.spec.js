...
describe('wmatic', () => {
  ...
  describe('basics', ()=> {
    ...
    it('provides basic structured data for wmatic', ()=> {
      ...
      expect(exchange.blockchains).toEqual(['polygon'])
      ...
      expect(exchange.polygon.router.address).toEqual(blockchain.wrapped.address)
      expect(exchange.polygon.router.api).toEqual(WETH.WETH)
    })
  })
})
