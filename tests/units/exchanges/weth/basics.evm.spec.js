...
describe('weth', () => {
  ...
  describe('basics', ()=> {
    ...
    it('provides basic structured data for weth', ()=> {
      ...
      expect(exchange.blockchains).toEqual(['ethereum'])
      ...
      expect(exchange.ethereum.router.address).toEqual(blockchain.wrapped.address)
      expect(exchange.ethereum.router.api).toEqual(WETH.WETH)
    })
  })
})
