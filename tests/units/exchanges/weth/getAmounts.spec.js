...
describe('weth', () => {
  ...
  describe('getAmounts', ()=>{
    ...
    it('provides the same amounts (amountIn==amountOut) for ETH<>WETH', async ()=> {
      ...
      const path = ['0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', CONSTANTS.ethereum.WRAPPED]
    ...
    it('provides the same amounts (amountIn==amountOut) for WETH<>ETH', async ()=> {
      ...
      const path = [CONSTANTS.ethereum.WRAPPED, '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE']
      const amountOut = '100000000000'
