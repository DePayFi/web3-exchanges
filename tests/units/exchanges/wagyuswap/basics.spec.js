...
import { PancakeRouter, PancakeFactory, PancakePair } from 'src/exchanges/wagyuswap/apis'
...
describe('wagyuswap', () => {
  ...
  describe('basics', ()=> {
    ...
    it('provides basic structured data for wagyuswap', ()=> {
      ...
      expect(exchange.router.api).toEqual(PancakeRouter)
      expect(exchange.factory.address).toEqual('0x69f3212344a38b35844cce4864c2af9c717f35e3')
      expect(exchange.factory.api).toEqual(PancakeFactory)
      expect(exchange.pair.api).toEqual(PancakePair)
    })
  })
})
